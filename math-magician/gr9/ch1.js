  ...
  topics: [
    {
        ...
        body: `
          ...
          <div class="def-box">
            ...
            <p>
              ...
              <strong>Irrational numbers:</strong> non-terminating, non-recurring decimals (e.g. <span class="math">v2, p</span>).<br>
              <strong>Real numbers (R):</strong> all rational and irrational numbers.
            </p>
          </div>
          <div class="example-box">
            <div class="example-box-title">?? Classifying numbers</div>
            ...
            <div class="example-step"><span class="step-num">3</span><span>Classify <span class="math">v7</span>: irrational ?, real ? (not rational)</span></div>
      ...
      questions: [
        { type: "mc", text: "Which of these is irrational?", options: ["0,25", "v9", "v5", "-7"], answer: 2, topic: "Number Systems" },
