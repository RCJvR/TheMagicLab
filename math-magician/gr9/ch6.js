  ...
  topics: [
    ...
    },
    {
        ...
        body: `
          ...
          <div class="def-box">
            ...
            <p>
              ...
              <strong>Exponential:</strong> y = b? (b > 0, b ? 1) ? always positive, never touches x-axis.
            </p>
          </div>
          <div class="example-box">
            <div class="example-box-title">?? Key features</div>
      ...
      questions: [
        ...
        { type: "mc", text: "Which function has a graph that is a U-shape (parabola)?", options: ["y = 3x + 1", "y = 3/x", "y = x�", "y = 2?"], answer: 2, topic: "Functions" },
