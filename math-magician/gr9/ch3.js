  ...
  topics: [
    ...
    },
    {
      ...
      lesson: {
        ...
        body: `
          ...
          <div class="example-box">
            ...
            <div class="example-step"><span class="step-num">2</span><span>5/11: 5 ÷ 11 = 0,4̇5̇ (recurring)</span></div>
            <div class="example-step"><span class="step-num">3</span><span>Convert 0,83̇: let x = 0,83̇; 10x = 8,3̇; 9x = 7,5; x = 7,5/9 = 15/18 = 5/6</span></div>
      ...
      questions: [
        ...
        { type: "mc", text: "Express 0,2̇ (= 0,222̇) as a fraction:", options: ["2/9", "1/5", "2/10", "22/99"], answer: 0, topic: "Decimals" },
        { type: "input", text: "Convert 0,45 to a percentage.", answer: "45", topic: "Decimals" },
        { type: "mc", text: "Which decimal is equivalent to 5/12?", options: ["0,416̇", "0,41̇6̇", "0,4166̇", "Both a) and c)"], answer: 3, topic: "Decimals" },
    ...
    topics: [
      ...
      },
      {
        ...
        answers: [
          ...
          { num: "Q2d", ans: "73/90", note: "let x = 0,81̇; 10x = 8,1̇; 90x = 73; x = 73/90" },
