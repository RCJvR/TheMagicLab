  ...
  topics: [
    {
      ...
      lesson: {
        ...
        The angle bisectors of a triangle meet at the incentre.</span></div>
          ...
          <div class="tip-box"><span class="tip-icon">💡</span><span>For SSS constructions, if the sum of the two shorter sides ≤ longest side, no triangle is possible — the sides won't meet (this is known as the
          <div class="def-box" style="border-color:rgba(99,102,241,0.30);background:rgba(99,102,241,0.07);">
