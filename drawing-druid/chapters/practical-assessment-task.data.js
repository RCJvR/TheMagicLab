    ...
    CONSTRUCTIONS['pat-phases'] = {
      ...
      steps: [
        ...
        },
        {
          ...
          calloutAt: [120, 60],
          reveals: [
            { kind: 'line', p1: [70, 60], p2: [90, 60], lineType: 'construction' },
            { kind: 'polygon', points: [[90, 40], [150, 40], [150, 80], [90, 80]], lineType: 'A' },
            { kind: 'label', at: [120, 55], text: 'PHASE 2', size: 5, anchor: 'middle', color: '#fde047' },
            { kind: 'label', at: [120, 65], text: 'Instrument /', size: 3.4, anchor: 'middle', color: '#94a3b8' },
            { kind: 'label', at: [120, 71], text: 'CAD Drawings', size: 3.4, anchor: 'middle', color: '#94a3b8' },
            { kind: 'label', at: [120, 90], text: 'TERM 3', size: 3.6, anchor: 'middle', color: '#e8eaf2' },
          ],
        },
        {
          id: 3,
          ...
          reveals: [
            { kind: 'line', p1: [150, 60], p2: [170, 60], lineType: 'construction' },
            { kind: 'polygon', points: [[170, 40], [230, 40], [230, 80], [170, 80]], lineType: 'A' },
            { kind: 'label', at: [200, 55], text: 'PHASE 3', size: 5, anchor: 'middle', color: '#fde047' },
            { kind: 'label', at: [200, 65], text: 'Portfolio', size: 3.4, anchor: 'middle', color: '#94a3b8' },
            { kind: 'label', at: [200, 71], text: 'Compilation', size: 3.4, anchor: 'middle', color: '#94a3b8' },
            { kind: 'label', at: [200, 90], text: 'TERM 3', size: 3.6, anchor: 'middle', color: '#e8eaf2' },
          ],
        },
      ],
    };
